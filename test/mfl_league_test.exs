defmodule MFLLeagueTest do
  ...
  test "rules/3", %{league: league, year: year, bypass: bypass} do
    body =
      ~s<{"version":"1.0","rules":{"positionRules":[{"positions":"Def","rule":[{"points":{"$t":"10"},"range":{"$t":"0-0"},"event":{"$t":"STPA+OPA"}},{"points":{"$t":"7"},"range":{"$t":"1-7"},"event":{"$t":"STPA+OPA"}}]},{"positions":"QB|RB|WR|TE","rule":[{"points":{"$t":"*4"},"range":{"$t":"0-99"},"event":{"$t":"#P"}},{"points":{"$t":".05/1"},"range":{"$t":"-100-999"},"event":{"$t":"PY"}}]},{"positions":"TE","rule":{"points":{"$t":"*1"},"range":{"$t":"0-99"},"event":{"$t":"CC"}}}]},"encoding":"utf-8"}>
  ...
  test "salaries/3", %{league: league, year: year, bypass: bypass} do
    body =
      ~s<{"salaries":{"leagueUnit":{"unit":"LEAGUE","player":[{"contractYear":"","contractStatus":"","id":"0000","contractInfo":"","salary":"0.00"},{"contractYear":"19","contractStatus":"4L-2020E","id":"12155","contractInfo":"Extended","salary":"13"}]}},"version":"1.0","encoding":"utf-8"}>
  ...
  test "schedule/3", %{league: league, year: year, bypass: bypass} do
    body =
      ~s<{"version":"1.0","schedule":{"weeklySchedule":[{"matchup":[{"franchise":[{"isHome":"0","score":"148","id":"0005","result":"W"},{"isHome":"1","score":"128","id":"0003","result":"L"}]}],"week":"16"},{"week":"17"}]},"encoding":"utf-8"}>
  ...
  test "weekly_results/3", %{league: league, year: year, bypass: bypass} do
    body =
      ~s<{"version":"1.0","weeklyResults":{"franchise":[{"player":[{"status":"starter","id":"11674","shouldStart":"1","score":"23"}],"optimal":"12140,11674,","score":"143","comments":"Best Lineup","opt_pts":"143","starters":"12140,11674,","id":"0001","nonstarters":"13319,13391,"}],"week":"17"},"encoding":"utf-8"}>
  ...
  test "live_scoring/3", %{league: league, year: year, bypass: bypass} do
    body =
      ~s<{"liveScoring":{"matchup":[{"franchise":[{"playersCurrentlyPlaying":"0","gameSecondsRemaining":"0","isHome":"0","players":{"player":[{"gameSecondsRemaining":"0","status":"nonstarter","updatedStats":"","score":"0","id":"12211"}]},"playersYetToPlay":"0","score":"179","id":"0005"}]}], "week":"17"},"version":"1.0","encoding":"utf-8"}>
  ...
  describe "player_scores/3" do
    test "when week is not specified", %{league: league, year: year, bypass: bypass} do
      body =
        ~s<{"playerScores":{"playerScore":[{"week":"1","score":"8.20","id":"8658"}]},"version":"1.0","encoding":"utf-8"}>
    ...
    test "when week is specified", %{league: league, year: year, bypass: bypass} do
      body =
        ~s<{"playerScores":{"week":"12","playerScore":[{"isAvailable":"0","score":"50.20","id":"10703"}]},"version":"1.0","encoding":"utf-8"}>
  ...
  test "draft_results/3", %{league: league, year: year, bypass: bypass} do
    body =
      ~s<{"draftResults":{"draftUnit":{"unit":"LEAGUE","draftType":"SDRAFT","draftPick":[{"timestamp":"1536019300","franchise":"0009","round":"01","player":"12150","pick":"01","comments":""}],"round1DraftOrder":"0009,0008,0002,0001,0004,0012,0005,0007,0011,0006,0003,0010,"}},"version":"1.0","encoding":"utf-8"}>
  ...
  test "future_draft_picks/3", %{league: league, year: year, bypass: bypass} do
    body =
      ~s<{"version":"1.0","futureDraftPicks":{"franchise":[{"futureDraftPick":[{"round":"1","originalPickFor":"0001","year":"2019"}],"id":"0008"}]},"encoding":"utf-8"}>
  ...
  test "auction_results/3", %{league: league, year: year, bypass: bypass} do
    body =
      ~s<{"version":"1.0","auctionResults":{"auctionUnit":{"auction":[{"lastBidTime":"1526347741","franchise":"0012","player":"13590","timeStarted":"1526347701","winningBid":"42"}],"unit":"LEAGUE"}},"encoding":"utf-8"}>
  ...
  test "transactions/3", %{league: league, year: year, bypass: bypass} do
    body =
      ~s<{"version":"1.0","transactions":{"transaction":[{"timestamp":"1550025518","franchise":"0003","transaction":"|12617,","type":"FREE_AGENT"},{"activated":"11760,11660,8670,11688,8416,","timestamp":"1546148485","franchise":"0001","deactivated":"","type":"IR"}]},"encoding":"utf-8"}>
  ...
  test "projected_scores/3", %{league: league, year: year, bypass: bypass} do
    body =
      ~s<{"projectedScores":{"week":"13","playerScore":{"score":"17","id":"12171"}},"version":"1.0","encoding":"utf-8"}>
  ...
  test "message_board/3", %{league: league, year: year, bypass: bypass} do
    body =
      ~s<{"version":"1.0","messageBoard":{"thread":[{"franchise_id":"0000","lastPostTime":"1441332551","subject":"DRAFT DAY IS SATURDAY BE THERE AT 9:30!!","id":"4416836"}]},"encoding":"utf-8"}>
  ...
  test "message_board_thread/4", %{league: league, year: year, bypass: bypass} do
    body =
      ~s<{"version":"1.0","messageBoardThread":{"post":[{"body":"As per my last message","franchise":"0000","postTime":"1434592222"}]},"encoding":"utf-8"}>
  ...
  describe "player_status/4" do
    test "with one player passed", %{league: league, year: year, bypass: bypass} do
      body =
        ~s<{"version":"1.0","playerStatus":{"status":"Undisclosed Injury - S","id":"12171"},"encoding":"utf-8"}>
  ...
  test "points_allowed/3", %{league: league, year: year, bypass: bypass} do
    body =
      ~s<{"pointsAllowed":{"team":[{"position":[{"points":"358","name":"RB"},{"points":"264","name":"QB"},{"points":"143","name":"TE"},{"points":"416","name":"WR"}],"id":"MIN"}]},"version":"1.0","encoding":"utf-8"}>
  ...
  test "pool/3", %{league: league, year: year, bypass: bypass} do
    body =
      ~s<{"version":"1.0","poolPicks":{"franchise":[{"week":[{"game":[{"matchup":"PIT,NEP","pick":"NEP","rank":"1"}], "week":"1"}],"id":"0001"}],"use_weights":"Pickem","vs_spread":"No","endWeek":"17","type":"NFL","startWeek":"1"},"encoding":"utf-8"}>
  ...
  test "playoff_brackets/3", %{league: league, year: year, bypass: bypass} do
    body =
      ~s<{"version":"1.0","playoffBrackets":{"playoffBracket":[{"startWeekGames":"2","name":"Playoffs","startWeek":"14","teamsInvolved":"6","id":"1","bracketWinnerTitle":"Champion"}]},"encoding":"utf-8"}>
  ...
  test "appearance/3", %{league: league, year: year, bypass: bypass} do
    body =
      ~s<{"version":"1.0","appearance":{"skin":"74","tab":[{"name":"Main","id":"0","module":[{"name":"COLUMN=100"}]}]},"encoding":"utf-8"}>
